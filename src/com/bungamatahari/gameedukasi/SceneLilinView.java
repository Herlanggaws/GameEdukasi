...
public class SceneLilinView extends View {
    ...
    public SceneLilinView(Context context, AttributeSet attrs) {
           super(context, attrs);  

            mGreen  = context.getResources().getDrawable(
                      R.drawable.background_grass);
    ...
    public void onDraw(Canvas canvas) {
            ...
            for (int i=0; i<= mVol; i++) {
                    ...
                    bar.setBounds((5)*mWidth, 0, (15)*mWidth, mHeight); // ganti gambar disatu tempat
                    bar.draw(canvas);
            }
